...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 40
    invoke-interface {p1, p2, p3}, Lokio/e;->k(J)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 27
    .line 28
    sget-object p3, Lokio/f;->t:Lokio/f;
    ...
    .line 35
    invoke-interface {p3, v2, v3}, Lokio/e;->u(J)Lokio/f;
    ...
    .line 39
    :cond_0
    invoke-interface {p1, p4, v1, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lokio/f;)V
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    .line 6
    .line 7
    invoke-interface {v2, v3, v4}, Lokio/e;->T0(J)V
    :try_end_0
    ...
    .line 94
    invoke-interface {p1, v2, v3}, Lokio/e;->k(J)V
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    .line 32
    invoke-interface {p1, v3, v4}, Lokio/e;->u(J)Lokio/f;
