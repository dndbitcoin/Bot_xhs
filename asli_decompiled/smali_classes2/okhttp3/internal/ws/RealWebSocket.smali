...
.method private declared-synchronized send(Lokio/f;I)Z
    .locals 6
...
.method declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILokio/f;J)V
...
.method public connect(Lokhttp3/OkHttpClient;)V
    ...
    .line 68
    .line 69
    invoke-interface {p1}, Lokhttp3/Call;->timeout()Lokio/t;
    ...
    .line 73
    invoke-virtual {p1}, Lokio/t;->clearTimeout()Lokio/t;
...
.method declared-synchronized pong(Lokio/f;)Z
    .locals 1
...
.method writeOneFrame()Z
    ...
    .line 102
    .line 103
    iget-object v1, v1, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Lokio/f;
    ...
    .line 122
    invoke-interface {v0, v1}, Lokio/d;->K0(Lokio/f;)Lokio/d;
    ...
    .line 151
    .line 152
    iget-object v3, v3, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Lokio/f;

    .line 153
    .line 154
    invoke-virtual {v0, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILokio/f;)V
...
.method writePingFrame()V
    ...
    :cond_2
    :try_start_1
    sget-object v1, Lokio/f;->t:Lokio/f;
